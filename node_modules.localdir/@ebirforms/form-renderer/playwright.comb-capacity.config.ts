...
export default defineConfig({
  ...
  testMatch: "comb-capacity-audit.spec.ts",
  outputDir: "../../test-results/form-renderer-comb-capacity",
  fullyParallel: false,
  retries: 0,
  workers: 1,
  reporter: [["list"]],
  ...
  webServer: {
    command:
      "npm run dev --workspace @ebirforms/form-preview -- --host 127.0.0.1 --port 4180 --strictPort",
