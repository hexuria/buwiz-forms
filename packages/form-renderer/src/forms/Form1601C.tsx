    ...
    <section className="guidelines-1601c">
      ...
      <div className="guideline-columns-1601c">
        <div>
          ...
          <p>The return shall be filed and the tax paid/remitted on or before the tenth (10th) day of the month following the month in which withholding was made except for taxes withheld for December which shall be filed and paid/remitted on or before January 15 of the succeeding year.</p>
