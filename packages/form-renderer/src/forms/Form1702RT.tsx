...
function ScheduleThree1702RT({ envelope }: { envelope: RenderEnvelope }) {
  return <section className="schedule-1702rt schedule-three-1702rt"><h3>Schedule III – Computation of Net Operating Loss Carry Over (NOLCO)</h3>
    ...
    <div className="nolco-continuation-grid-1702rt nolco-heading-1702rt"><span>C) NOLCO Expired</span><span>D) NOLCO Applied Current Year</span><span>E) Net Operating Loss (Unapplied) [ E = A Less (B + C + D) ]</span></div>
...
function ScheduleFour1702RT({ envelope }: { envelope: RenderEnvelope }) {
  return <section className="schedule-1702rt schedule-four-1702rt"><h3>Schedule IV – Computation of Minimum Corporate Income Tax (MCIT)</h3>
    ...
    <div className="mcit-continuation-grid-1702rt mcit-heading-1702rt"><span>D) Excess MCIT Applied/Used in Previous Years</span><span>E) Expired Portion of Excess MCIT</span><span>F) Excess MCIT Applied this Current Taxable Year</span><span>G) Balance of Excess MCIT Allowable as Tax Credit for Succeeding Year/s</span></div>
