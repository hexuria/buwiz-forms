//! Re-run the Rust-owned PDF validator for a 2551Q macOS candidate export.
//!
...
fn main() -> ExitCode {
    ...
    match run(Path::new(&pdf_path), &envelope_sha256) {
...
#[cfg(test)]
mod tests {
    use super::{canonical_sha256, run, HEIGHT_POINTS, PAGE_COUNT, WIDTH_POINTS};
