...
impl TaxRule for TrainLaw8PercentRule {
    ...
    fn citation(&self) -> LegalCitation {
        LegalCitation {
            ...
            number: "10963".into(),
            section: "Sec 24(A)(2)(b) - 8% in lieu of graduated + percentage tax".into(),
            year: 2018,
        }
    }
...
impl TaxRule for TrainLaw2551MAbolitionRule {
    ...
    fn citation(&self) -> LegalCitation {
        LegalCitation {
            ...
            kind: CitationKind::RepublicAct,
            number: "10963".into(),
            section: "Sec 116 - Monthly percentage tax abolished".into(),
            year: 2018,
        }
    }
    fn effective_from(&self) -> u16 {
    ...
    fn evaluate(
        ...
        if form.form_code == "2551M" {
            return FormEligibility::Deprecated(
                "Monthly percentage tax abolished by TRAIN Law 2018".into(),
            );
        }
        current_state
    }
...
impl TaxRule for TrainLaw1601EReplacement {
    ...
    fn citation(&self) -> LegalCitation {
        LegalCitation {
            citation_id: String::new(),
            kind: CitationKind::RevenueRegulation,
            number: "11-2018".into(),
            section: "1601E replaced by 0619E/1601EQ".into(),
            year: 2018,
        }
    }
    fn effective_from(&self) -> u16 {
    ...
    fn evaluate(
        ...
        if form.form_code == "1601E" {
            return FormEligibility::Deprecated(
                "Replaced by 0619E and 1601EQ under TRAIN Law".into(),
            );
        }
        current_state
    }
