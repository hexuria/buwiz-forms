...
edits belong in html-frozen/ as direct HTML commits. This script is not a
generator and is not shipped in a separate html repo until one exists.

Intended home is hexuria/buwiz-forms-html, tag v1-frozen. This in-repo tree
is the product freeze when that repository cannot be created.
"""
