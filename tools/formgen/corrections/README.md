...
| **P0b** | `gol/tin-stage5` | Named Stage 1 batch is `ddac6058`. This commit re-anchors C01–C07 (C01 `p1c116`→`p1c127`). Run `correct.py --batch ddac6058`. | Stage 2. Serial — records bind HTML bytes. |
