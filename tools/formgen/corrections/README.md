...
| **P0b** | `gol/tin-stage5` | Named Stage 1 `forms/` batch is this layer. Re-anchor C01–C07 against it (C01 `p1c116`→`p1c127`; `data-row` shifted) and run `correct.py`. | Stage 2. Serial — records bind HTML bytes. |
